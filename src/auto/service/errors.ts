 ...
 */
export class TitelExists extends AutoServiceError {
    constructor(
 ...
 */
export class IsbnExists extends AutoServiceError {
    constructor(
 ...
 */
export type CreateError = AutoInvalid | IsbnExists | TitelExists;
