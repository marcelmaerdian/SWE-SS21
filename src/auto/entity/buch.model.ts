...
import type { Auto, AutoArt, Verlag } from './Auto';
 ...
 * Interface {@linkcode Auto}
 */
export class AutoDocument extends Document<string> implements Auto {
 ...
 */
export const AutoModel = model<AutoDocument>('Auto', AutoSchema); // eslint-disable-line @typescript-eslint/naming-convention
